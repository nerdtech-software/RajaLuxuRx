...
const Registration = () => {
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 pt-56 pb-10">
          ...
          <div className=" lg:w-2/6 bg-white shadow-lg rounded-lg flex flex-col lg:flex-row overflow-hidden">
            {/* Left Section - Text */}
